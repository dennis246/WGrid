...
function emitWMenuBoxPanel() {
    ...
    wmenubox.id = "wmenubox";
    wmenubox.className = "wmenubox";
    wmenubox.style.minWidth = "10rem";
    wmenubox.style.setProperty("border", "2px solid black");
    wmenubox.style.display = "flex";

    var wmenuipbox = document.createElement("input");
    wmenuipbox.id = "wmenuipbox";
    wmenuipbox.className = "wmenuipbox";
    wmenubox.setAttribute("type", "text");
    wmenubox.setAttribute("value", "Select...");
    wmenubox.style.width = "90%";
    wmenubox.style.border = "1px solid transparent";
    wmenubox.style.outline = "0";

    var wmenuipdelbtn = document.createElement("div");
    wmenuipdelbtn.id = "wmenuipdelbtn";
    wmenuipdelbtn.className = "wmenuipdelbtn";
    wmenubox.setAttribute("type", "button");
    wmenubox.setAttribute("value", "x");
